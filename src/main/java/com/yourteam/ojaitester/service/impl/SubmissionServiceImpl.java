...
public class SubmissionServiceImpl implements SubmissionService {
    ...
    @Override
    public SubmissionResult submitCode(String code, com.yourteam.ojaitester.dto.TestCase testCase, String problemName) {
        CppExecutionEngine executionEngine = new CppExecutionEngine();
        try {
            File executable = executionEngine.compileCode(code, problemName);
